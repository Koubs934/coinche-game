...
export default {
  ...
  ambiguousPlayer: 'Several accounts share this name — sign in with your email',
  usernameTaken: 'This player name is already taken',
  usernameNoAt: "The player name can't contain @",
  authNetworkError: 'Connection error — please try again',
  authInvalidCredentials: 'Incorrect player name or password',
  authEmailNotConfirmed: 'Email not confirmed — check your inbox',
  authWeakPassword: 'Password too weak',
  authSamePassword: 'The new password must be different from the old one',
  authEmailTaken: 'An account already exists with this email',
  ...
  resetEmailSent: 'If this address exists, an email has been sent.',
  ...
  resetLinkInvalid: 'This link is invalid or has expired.',
