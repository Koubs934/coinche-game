...
export default {
  ...
  ambiguousPlayer: 'Plusieurs comptes portent ce nom — connecte-toi avec ton e-mail',
  usernameTaken: 'Ce nom de joueur est déjà pris',
  usernameNoAt: 'Le nom de joueur ne peut pas contenir @',
  authNetworkError: 'Erreur de connexion — réessaie',
  authInvalidCredentials: 'Nom de joueur ou mot de passe incorrect',
  authEmailNotConfirmed: 'E-mail non confirmé — vérifie ta boîte mail',
  authWeakPassword: 'Mot de passe trop faible',
  authSamePassword: "Le nouveau mot de passe doit être différent de l'ancien",
  authEmailTaken: 'Un compte existe déjà avec cet e-mail',
  accountCreated: 'Compte créé ! Vérifie ton e-mail pour confirmer, puis connecte-toi.',
  forgotPassword: 'Mot de passe oublié ?',
  forgotTitle: 'Mot de passe oublié',
  sendResetLink: 'Envoyer le lien',
  resetEmailSent: 'Si cette adresse existe, un email a été envoyé.',
  ...
  resetSuccess: 'Mot de passe mis à jour ! Redirection vers la connexion…',
  resetLinkInvalid: 'Ce lien est invalide ou a expiré.',
  ...
  training: {
    ...
    picker: {
      ...
      sectionLabels:        { '120': 'Conventions 120' },
      sectionDefault:       'Autres scènes',
      // Family filter chips + search box + sort toggle.
      familyAll:            'Toutes',
      familyLabels:         { '120': '120', 'Ouvertures': 'Ouvertures', 'Réponses': 'Réponses', 'Compétitif': 'Compétitif', 'Validation': 'Validation', 'Autres': 'Autres' },
      sortByNumber:         'Numéro',
      sortByFamily:         'Famille',
      searchPlaceholder:    'Rechercher une scène…',
      emptyFiltered:        'Aucune scène.',
    },
    completion: {
